  ...
  const products: Product[] = [
    {
      ...
      imageSrc:
        "https://pwa-cdn.alsaifgallery.com/media/catalog/product/cache/69ac3f4e9a6e4cbfdfdd61c00da77ca5/_/1/_1_2_1200x1200_-_1_3_1.jpg?width=300",
  ...
  return (
    <div>
      {products.map((product, index) => (
        <div
          key={index}
          id="cart_product_component_container"
...
export default function CheckoutLayout({
  ...
  useEffect(() => {
    if (
      pathname.includes("/checkout1/login") ||
      pathname.includes("/checkout1/register")
    ) {
      setActiveStep(1);
