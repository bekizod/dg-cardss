  ...
  return (
    <div className="flex flex-col gap-4 p-4 dark:bg-gray-800 dark:text-white">
      <div className="flex justify-center mt-4">
        <motion.button className="bg-green-500 text-white p-2 rounded-full  justify-center items-center shadow-md hover:bg-green-600 transition duration-300 dark:bg-green-600 dark:hover:bg-green-700" onClick={() => setShowMap(!showMap)} initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.3 }}>
