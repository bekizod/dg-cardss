      ...
      <div className="flex flex-col md:flex-row gap-3 w-full">
        ...
        <div className="mt-4 md:mt-0 p-4 bg-gray-50 dark:bg-gray-800 shadow-lg rounded-xl w-full md:w-1/4">
          ...
          <Link href="/checkout" passHref>
            <motion.button whileTap={{ scale: 0.95 }} className="w-full mt-6 bg-blue-500 text-white py-2 rounded-lg hover:bg-blue-600 dark:bg-blue-700 dark:hover:bg-blue-600">
              Checkout
            </motion.button>
          </Link>
        </div>
