...
const BannerSection = () => {
  return (
    <>
      <motion.div className="relative flex py-3 gap-2" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 1 }}>
      ...
      <motion.div className="relative flex pb-3 gap-2" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 1 }}>
      ...
      <motion.div className="relative h-full flex gap-2" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 1 }}>
        ...
        <div className="relative  w-1/3">
          <div className="flex flex-col h-full justify-between">
            <motion.div className="h-1/2" initial={{ x: 100 }} animate={{ x: 0 }} transition={{ duration: 0.5 }}>
              <Link href="/SA_en/electrical-appliances/canister-vacuums.html" className="block h-full">
                <Image width={1000} height={1000} src="https://pwa-cdn.alsaifgallery.com/media/wysiwyg/vacuums-EN_2.jpg" alt="banner" loading="lazy" fetchPriority="low" className="w-full h-full object-cover rounded-xl" />
              </Link>
            </motion.div>
            <motion.div className="h-1/2 mt-2" initial={{ x: 100 }} animate={{ x: 0 }} transition={{ duration: 0.5 }}>
              <Link href="/SA_en/electrical-appliances/coffee-machines.html" className="block h-full">
                <Image width={1000} height={1000} src="https://pwa-cdn.alsaifgallery.com/media/wysiwyg/Coffe-maker-EN_3.jpg" alt="banner" loading="lazy" fetchPriority="low" className="w-full h-full object-cover rounded-xl" />
              </Link>
            </motion.div>
          </div>
        </div>
